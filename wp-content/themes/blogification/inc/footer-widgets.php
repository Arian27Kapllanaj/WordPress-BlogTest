...
class  Blogification_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'blogification';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'blogification' ), $i ),
...
// Initialize.
$blogification_footer_widgets = new  Blogification_Footer_Widgets();
