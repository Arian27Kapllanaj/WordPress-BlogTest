 ...
 * @return array
 */
function blogification_body_classes( $classes ) {
	...
	if ( is_singular() || is_home() ) {
		$id = ( is_home() && ! is_front_page() ) ? get_option( 'page_for_posts' ) : get_the_id();
	  	$sidebar = get_post_meta( $id, 'blogification-selected-sidebar', true );
...
add_filter( 'body_class', 'blogification_body_classes' );
